...
public class youreWinner : MonoBehaviour {
	...
	void Update () {
        if (p1.transform.position.y < 500)
        {
            if (p2.transform.position.y < 500)
            {
                if (p3.transform.position.y < 500)
                {
                    //PLAYER 4 WINS
                ...
                else if (p4.transform.position.y < 500)
            ...
            else if (p3.transform.position.y < 500 && p4.transform.position.y < 500)
            {
                //PLAYER 2 WINS
        ...
        else if (p3.transform.position.y < 500 && p4.transform.position.y < 500 && p2.transform.position.y < 500)
